...
public class Lexer {
    ...
    private final List<String> directive = Arrays.asList("package", "import");
    private final List<LexemValue> lexemes = new ArrayList<LexemValue>();
    private boolean isComment = false;

    public void DisplayResults()
    {
        for (LexemValue t : lexemes)
        {
